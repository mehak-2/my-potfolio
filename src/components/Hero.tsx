        ...
        >
          ...
          <div className="flex gap-3 md:justify-end flex-wrap">
            ...
            <a
              ...
              download
              className="px-7 py-3 text-xs tracking-widest uppercase rounded-full inline-flex items-center gap-2 border border-accent/40 text-accent-light hover:text-foreground hover:border-accent hover:bg-accent/10 transition-all duration-300 group"
            >
              <svg className="group-hover:translate-y-0.5 transition-transform" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
